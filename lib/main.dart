...
class PartyChatData {
  ...
  static DocumentReference<Map<String, dynamic>> _user(
    String uid,
  ) {
    return _users().doc(uid);
  }

  static CollectionReference<Map<String, dynamic>> _friends(
    String uid,
  ) {
    return _user(uid).collection('friends');
  }

  static CollectionReference<Map<String, dynamic>> _requests(
    String uid,
  ) {
    return _user(uid).collection('friendRequests');
  }
  ...
  static Future<Map<String, dynamic>?> findUserByUid(
    ...
    final doc = await _user(value).get();
  ...
  static Future<void> acceptFriendRequest({
    ...
    final myUser =
        await _user(myUid).get();

    final otherUser =
        await _user(otherUid).get();
